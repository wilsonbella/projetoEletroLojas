...
const Contatos = () => {
    ...
    React.useEffect(async () =>{
        const url = "http://localhost/eletro_lojas/comments.php";
    ...
    function registerComment(event) {
        ...
        const url = "http://localhost/eletro_lojas/register_comment.php";
            ...
            <div className="container">
                <div className="row">
                    <div className="col text-center"> 
                        <img src="./imagens/email.jpeg" alt="email-logo" className="w-5"/>
                        <span>contato@eletrolojas.com</span>
                    </div>
                    <div className="col text-center">
                        <img src="./imagens/whatsapp.jpeg" alt="whats-logo" className="w-5"/>
                        <span>(11)94532-5487</span>
                    </div>
                </div>
            </div>
            <br/><br/>
